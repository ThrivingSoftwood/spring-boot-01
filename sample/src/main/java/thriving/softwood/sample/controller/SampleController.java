...
import thriving.softwood.sample.component.config.Sample;
import thriving.softwood.sample.pojo.vo.AncestorVO;
import thriving.softwood.sample.pojo.vo.ComplexTraceVO;
...
public class SampleController {
    ...
    /**
     * 触发多层级线程调用链 GET /sample/chain?msg=hello
     */
    ...
    /**
     * 触发复杂的多层级并行调用链 GET /sample/complex-chain
     */

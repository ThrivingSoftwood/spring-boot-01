// File: ./cust0001/src/main/java/thriving/softwood/cust0001/biz/api/sync/ErpSyncSvc.java
package thriving.softwood.customer.first.biz.api.sync;

import static thriving.softwood.customer.first.biz.constant.BaseConst.*;
...
import thriving.softwood.customer.first.infrastructure.db.kaishi2026.entity.base.Department;
import thriving.softwood.customer.first.infrastructure.db.kaishi2026.entity.base.Employee;
import thriving.softwood.customer.first.infrastructure.db.kaishi2026.entity.base.GblLoginUser;
import thriving.softwood.customer.first.infrastructure.db.kaishi2026.repo.DepartmentRepo;
import thriving.softwood.customer.first.infrastructure.db.kaishi2026.repo.EmployeeRepo;
import thriving.softwood.customer.first.infrastructure.db.kaishi2026.repo.GblLoginUserRepo;
...
public class ErpSyncSvc implements ErpSyncApi {
    ...
    public void syncUsers(ErpSyncReq req) {
        ...
        String currentVersion = DateUtil.format(new Date(), "yyyyMMddHHmmss");

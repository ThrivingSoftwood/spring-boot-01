...
public class SysDeptVO implements Serializable {
    ...
    public SysDeptVO(SysDept dept, DepartmentAssociationInfo associationInfo) {
        id = dept.getId();
        ...
        oriDepartmentTypeid = null == associationInfo ? null : associationInfo.getOriDepartmentTypeid();
    }
}

package thriving.softwood.kaishi.component.resolver;

import static thriving.softwood.common.auth.config.AncestorAuthConfig.AUTH_CACHE_KEY;
import static thriving.softwood.kaishi.infrastructure.cache.local.KaishiCaffeineCacheConfig.KAISHI_CACHE_KEY;
